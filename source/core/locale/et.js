...
gca_languages['et'] = {
	...
	locale : {
		...
		global : {
			...
			message_send : "Saada",
			message_sent_success : "Sõnumi saatmine õnnestus!",
			message_sent_failed : "Sõnumi saatmisel esines viga!",
			message_empty : "Sõnum puudub!",
			message_exclude_me : "Ära mind arvesta!",
			...
			guild_friends : "Guild sõbrad",
			family_friends : "Lähedased sõbrad",
			donate_gold_success : "Kuld annetatud!",
			donate_gold_failed : "Kulla annetamisel tekkis tõrge!",
			donate_gold_all_gold : "Anneta kogu kuld",
			quest_full : "Täis",
			quest_new : "Uus",
			notification_guild_application : "Gildi taotlused",
			gold_exp_data_to_level_up : "Päevi jäänud leveliks"
		},
		overview : {},
		pantheon : {},
		guild : {
			bank_all_gold : "Lisa kogu kuld",
			medic_lost_points : "Kaotatud punktid",
			medic_points_to_heal : "Punkte tervendamiseks",
			medic_life_after_heal : "Elud peale tervendamist"
		},
		training : {},
		auction : {
		...
		settings : {
			...
			save : "Salvesta",
			notification_reload : "Teate uuesti näitamine"
		}
	},
	locale_deprecated : {
		...
		quest_new : "Uus",
		quest_full : "Täis",
		weapon_down : "Su relv on eemaldatud",
		leveling_stats : "Experience Stats",
		today_experience : "Tänane exp",
		days7_experience : "7 päeva exp",
		avarage_experiance_per_day : "Keskmine exp päevas",
